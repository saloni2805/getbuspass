...
{               ?>
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Old Photo</label> <img src="images/<?php echo $row->ProfileImage;?>" width="50" height="50" value="<?php  echo $row->ProfileImage;?>"> </div>
